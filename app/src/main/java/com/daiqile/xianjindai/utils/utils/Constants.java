...
public final class Constants {
    ...
    //异步通知回调地址
    public static final String NOTIFY_URL = "http://test.yintong.com.cn:80/apidemo/API_DEMO/notifyUrl.htm";//测试的
//    public static final String NOTIFY_URL = "http://121.199.54.237:9591/xjd/front/user/myInfo";
}
