package com.phonegap.picselector;
...
import com.phonegap.picselector.adapter.FolderAdapter;
import com.phonegap.picselector.adapter.ImageGridAdapter;
import com.phonegap.picselector.bean.Folder;
import com.phonegap.picselector.bean.Image;
import com.phonegap.picselector.utils.FileUtils;
import com.phonegap.picselector.utils.ScreenUtils;
            ...
            if (intent.resolveActivity(getActivity().getPackageManager()) != null) {
                if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.N){
                    ...
                    imageUriFromCamera = FileProvider.getUriForFile(getActivity(),
                            "com.phonegap.picselector.provider", mTmpFile);
